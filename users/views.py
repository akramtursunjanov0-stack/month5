...
from .models import ConfiMationCode
...
class RegistrationAPIView(APIView):
    def post(self, request):
        ...
        code = ConfiMationCode.generate_code()
        ConfiMationCode.objects.create(user=user, code=code)
...
class ConfrimationAPIView(APIView):
    def post(self, request):
        ...
        try:
            ...
            confirm = ConfiMationCode.objects.get(user=user, code=code)
        ...
        except ConfiMationCode.DoesNotExist:
            return Response(
